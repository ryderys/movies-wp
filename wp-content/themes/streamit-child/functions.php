...
require_once get_stylesheet_directory() . '/inc/media-player-rewrite.php';
require_once get_stylesheet_directory() . '/inc/pmpro-currency.php';
...
require_once get_stylesheet_directory() . '/inc/content-media-cleanup.php';
