            ...
            <div class="offcanvas offcanvas-start filter-offcanvas" tabindex="-1" id="filteroffcanvas" aria-labelledby="filteroffcanvasLabel">
                ...
                <div class="offcanvas-body">
                    <form class="m-0">
                        ...
                        <?php endif; ?>
                        <?php streamit_get_template( 'archive/country-filter.php', array( 'post_type' => 'tvshow' ) ); ?>
                        ...
                        <?php streamit_get_template( 'archive/duration-filter.php' ); ?>
                        <?php if (function_exists('streamit_get_terms')) : ?>
                        ...
                        <?php endif; ?>
                        <?php streamit_get_template( 'archive/year-filter.php' ); ?>
                    </form>
                </div>
            </div>
        </div>
