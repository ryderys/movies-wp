...
<div class="streamit-login">
    ...
    <form id="streamit-login-form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
        ...
        <?php if (isset($streamit_options['streamit_signup_link'])) :
            ...
            $singup_title = (isset($streamit_options['streamit_signup_title']) && !empty($streamit_options['streamit_signup_title'])) ? $streamit_options['streamit_signup_title'] : esc_html__('Signup', 'streamit'); ?>
