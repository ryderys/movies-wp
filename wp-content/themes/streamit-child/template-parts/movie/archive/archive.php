            ...
            <div class="offcanvas offcanvas-start filter-offcanvas" tabindex="-1" id="filteroffcanvas" aria-labelledby="filteroffcanvasLabel">
                ...
                <div class="offcanvas-body">
                    <form class="m-0">
                        ...
                        <?php endif; ?>
                        <?php streamit_get_template( 'archive/country-filter.php', array( 'post_type' => 'movie' ) ); ?>
                        ...
                        <div class="filter-widget filter-widget-duration">
                            ...
                            <div class="filter-widget-inner">
                                <div class="filter-list">
                                    <?php
                                    $durations = array(
                                        array('value' => 'under_1_hour', 'id' => 'duration_under_1', 'text' => 'Under 1 Hour'),
                                        array('value' => '1_2_hours', 'id' => 'duration_1_2', 'text' => '1-2 Hours'),
                                        array('value' => '2_3_hours', 'id' => 'duration_2_3', 'text' => '2-3 Hours'),
                                        array('value' => '3_up', 'id' => 'duration_3_up', 'text' => '3+ Hours')
                                    );

                                    foreach ($durations as $duration) {
                                    ?>
                                        <div class="form-check">
                                            <input class="form-check-input streamit-filter" type="radio" value="<?php echo esc_attr($duration['value']); ?>" id="<?php echo esc_attr($duration['id']); ?>" name="duration">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <div class="<?php echo esc_attr($range['col_class']); ?>">
                                                    <div class="form-check">
                                                        <input class="form-check-input streamit-filter" type="radio" name="release_year" id="<?php echo esc_attr($range['id']); ?>" value="<?php echo esc_attr($range['value']); ?>">
