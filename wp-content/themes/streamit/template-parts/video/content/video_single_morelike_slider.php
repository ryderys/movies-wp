...
$st_video_id    = method_exists($st_data, 'get_id') ? $st_data->get_id() : '';
$term_ids       = streamit_get_term_relationships($st_video_id, 'video_genre');
...
$more_like_videos   = streamit_get_videos($query)->results;
if (empty($more_like_videos)) return;
