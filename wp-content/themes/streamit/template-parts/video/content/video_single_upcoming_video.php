<?php
/**
 * The template for displaying upcoming videos
 *
...
$upcoming_videos_meta_query = array(
    array(
        'key'     => 'video_upcoming_status',
        'value'   => '0', 
        'compare' => '!='
    )
);

$upcoming_list = streamit_get_videos([
    'per_page'   => 10,
    'meta_query' => $upcoming_videos_meta_query,
]);
...
if (is_array($show_upcoming_post) && in_array('video', $show_upcoming_post)) :
...
$slider_title = isset($streamit_options['streamit_upcoming_title']) && !empty($streamit_options['streamit_upcoming_title']) 
    ...
    : esc_html__('Upcoming Video', 'streamit');
