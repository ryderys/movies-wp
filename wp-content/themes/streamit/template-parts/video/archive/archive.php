...
<div class="container-fluid">
    <div class="archive-page-container">
                    ...
                    <form class="m-0">
                        <?php if ( function_exists('streamit_get_terms') ) : ?>
                            <div class="filter-widget filter-widget-genres">
                                <h5 class="filter-wiget-title"><?php echo esc_html__('ژانرها', 'streamit'); ?></h5>
                                <?php
                                    $genre_taxonomy = 'video_category';
                                    $per_page_genre = 6;
                        ...
                        <?php if (function_exists('streamit_get_terms')) : ?>
                            <div class="filter-widget filter-widget-tags">
                                <h5 class="filter-wiget-title"><?php echo esc_html__('بر اساس تگ ها', 'streamit'); ?></h5>
                                <?php
                                $taxonomy = 'video_tag';
        ...
        <div class="archive-page-item-2">
                ...
                <div class="css_prefix-card-wrapper video_cards grid-view" data-options="yes" data-can-beloaded="1">
                    ...
                    <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 data-listing">
                        <?php foreach ($content_data->results as $st_data) : ?>
                            <?php streamit_get_template('video/archive/archive_loop.php', ['st_data' => $st_data, 'view_type' => $view_type]); ?>
                        <?php endforeach; ?>
                    </div>
            ...
            <?php else : ?>
                <p><?php esc_html_e('No videos found.', 'streamit'); ?> </p>
            <?php endif; ?>
        </div>