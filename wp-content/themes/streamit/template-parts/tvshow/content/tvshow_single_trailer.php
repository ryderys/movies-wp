...
<div class="video-plus-image">
    ...
    $controllers['fullscreen'] = ['enabled' => true];
    ...
    if (!empty($st_trailer_details['trailer_link'])): ?>
        <div id="streamit-trailer-player-ctrl" class="streamit-trailer-player-ctrl" data-player_controls="<?php echo esc_attr(wp_json_encode(apply_filters('streamit_tvshow_trailer_player_controls', $controllers))); ?>">
            <?php if ($is_video): ?>
                <video class="streamit_trailer_player" autoplay muted playsinline loop loading="lazy">
