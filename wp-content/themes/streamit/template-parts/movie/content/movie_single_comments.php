...
// Check if the "Show Movie Comments" option is enabled
$show_comments = isset($streamit_core_options['streamit_movie_display_comment']) && $streamit_core_options['streamit_movie_display_comment'] === 'yes';
