    ...
    <div class="modal-dialog modal-dialog-centered share-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php esc_html_e('Share', 'streamit'); ?></h5>
                ...
                <div class="share-media-box">
                    <div class="media-box">
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url(streamit_get_permalink($st_data->get_post_type(), $st_data->get_post_name())) ?>" target="_blank">
                            ...
                            <span class="title"><?php esc_html_e('Facebook', 'streamit'); ?></span>
                        </a>
                    </div>
                    <div class="media-box">
                        <a href="https://twitter.com/intent/tweet?url=<?php echo esc_url(streamit_get_permalink($st_data->get_post_type(), $st_data->get_post_name())) ?>" target="_blank">
                            ...
                            <span class="title"><?php esc_html_e('Twitter', 'streamit'); ?></span>
                        </a>
                    </div>
                    <div class="media-box">
                        <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo esc_url(streamit_get_permalink($st_data->get_post_type(), $st_data->get_post_name())); ?>" target="_blank">
                            <span class="image-icon">
                                <?php echo st_get_icon('linkedin'); ?>

                            </span>
                            <span class="title"><?php esc_html_e('LinkedIn', 'streamit'); ?></span>
                        </a>
                    </div>
                    <div class="media-box">
                        <a href="https://api.whatsapp.com/send?text=<?php echo esc_url(streamit_get_permalink($st_data->get_post_type(), $st_data->get_post_name())) ?>" target="_blank">
                            ...
                            <span class="title"><?php esc_html_e('Whatsapp', 'streamit'); ?></span>
                        </a>
                    </div>
                </div>
                <div class="copy-link">
                    <h6><?php esc_html_e('Copy Link ', 'streamit'); ?></h6>
