...
class ST_Admin_Routes_Handler extends ST_Admin_Routes
{
    ...
    public function __construct()
    {
        ...
        $this->controller_path = get_template_directory() . '/admin/controllers/';
        parent::__construct();
    ...
    {
        add_action("wp_ajax_st_admin_ajax_post", [$this, 'handle_ajax_post']);
        add_action("wp_ajax_nopriv_st_admin_ajax_post", [$this, 'handle_ajax_post']);

        add_action("wp_ajax_st_admin_ajax_get", [$this, 'handle_ajax_get']);
        add_action("wp_ajax_nopriv_st_admin_ajax_get", [$this, 'handle_ajax_get']);
    }
