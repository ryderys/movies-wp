	...
	class Redux_Dimensions extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['width'] ) {
				...
				if ( isset( $this->field['width_label'] ) && ! Redux_Helpers::array_in_array( $this->field['width_label'], $unit_check ) ) {
					echo '<span class="width-label">',esc_html($this->field['width_label']),'</span>';
				}

				echo '<input
						type="text"
						class="redux-dimensions-input redux-dimensions-width mini ' . esc_attr( $this->field['class'] ) . '"
						placeholder="' . esc_html__( 'Width', 'streamit' ) . '"
				...
				echo '<span class="add-on"><i class="custom-width-arrow"></i></span>';
			...
			if ( true === $this->field['height'] ) {
				...
				echo '<div class="field-dimensions-input input-prepend">';
				if ( isset( $this->field['height_label'] ) && ! Redux_Helpers::array_in_array( $this->field['height_label'], $unit_check ) ) {
					echo '<span class="height-label">',esc_html($this->field['height_label']),'</span>';
				}
				echo '<input
						type="text"
						class="redux-dimensions-input redux-dimensions-height mini ' . esc_attr( $this->field['class'] ) . '"
						placeholder="' . esc_html__( 'Height', 'streamit' ) . '"
				...
				echo '<span class="add-on"><i class="custom-height"></i></span>';
			...
			if ( isset( $this->field['units'] ) && false !== $this->field['units'] ) {
				echo '<div
						...
						original-title="' . esc_html__( 'Units', 'streamit' ) . '">';

				if ( isset( $this->field['units_label'] ) && ! Redux_Helpers::array_in_array( $this->field['units_label'], $unit_check ) ) {
					echo '<span class="units-label">',esc_html($this->field['units_label']),'</span>';
				}

				echo '<select
						data-id="' . esc_attr( $this->field['id'] ) . '"
						data-placeholder="' . esc_html__( 'Units', 'streamit' ) . '"
