	...
	class Redux_Spacing extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['all'] ) {
				...
				echo '<div class="field-spacing-input input-prepend">
                        ...
                        <input
                            ...
                            placeholder="' . esc_html__( 'All', 'streamit' ) . '"
			...
			if ( false === $this->field['all'] ) {
				...
				if ( true === $this->field['top'] ) {
					echo '<div class="field-spacing-input input-prepend">';
				        if ( isset( $this->field['top_label'] ) && ! Redux_Helpers::array_in_array( $this->field['top_label'], $unit_check ) ) {
					        echo '<span class="width-label">',esc_html($this->field['top_label']),'</span>';
				        };
                        echo '<input type="text"
                                   class="redux-spacing-top redux-spacing-input mini ' . esc_attr( $this->field['class'] ) . '"
                                   placeholder="' . esc_html__( 'Top', 'streamit' ) . '"
                                   rel="' . esc_attr( $this->field['id'] ) . '-top"
                                   value="' . esc_attr( $this->value['top'] ) . '"/>
							<span class="add-on">
							    <i class="custom-up-arrow"></i>
						    </span>
                        </div>';
				}
				...
				if ( true === $this->field['bottom'] ) {
					echo '<div class="field-spacing-input input-prepend">';
							if ( isset( $this->field['bottom_label'] ) && ! Redux_Helpers::array_in_array( $this->field['bottom_label'], $unit_check ) ) {
								echo '<span class="width-label">', esc_html($this->field['bottom_label']),'</span>';
							};
                            echo '<input type="text"
                                   class="redux-spacing-bottom redux-spacing-input mini ' . esc_attr( $this->field['class'] ) . '"
                                   placeholder="' . esc_html__( 'Bottom', 'streamit' ) . '"
                                   rel="' . esc_attr( $this->field['id'] ) . '-bottom"
                                   value="' . esc_attr( $this->value['bottom'] ) . '">
							<span class="add-on">
							    <i class="custom-down-arrow"></i>
						    </span>
                        </div>';
				}
				...
				if ( true === $this->field['right'] ) {
					echo '<div class="field-spacing-input input-prepend">';
							if ( isset( $this->field['right_label'] ) && ! Redux_Helpers::array_in_array( $this->field['right_label'], $unit_check ) ) {
								echo '<span class="width-label">',esc_html($this->field['right_label']),'</span>';
							};
                            echo '<input type="text"
                                   class="redux-spacing-right redux-spacing-input mini ' . esc_attr( $this->field['class'] ) . '"
                                   placeholder="' . esc_html__( 'Right', 'streamit' ) . '"
				...
				if ( true === $this->field['left'] ) {
					echo '<div class="field-spacing-input input-prepend">';
							if ( isset( $this->field['left_label'] ) && ! Redux_Helpers::array_in_array( $this->field['left_label'], $unit_check ) ) {
								echo '<span class="width-label">',esc_html($this->field['left_label']),'</span>';
							};
                            echo '<input type="text"
                                   class="redux-spacing-left redux-spacing-input mini ' . esc_attr( $this->field['class'] ) . '"
                                   placeholder="' . esc_html__( 'Left', 'streamit' ) . '"
			...
			if ( false !== $this->field['units'] && true === $this->field['display_units'] ) {
				echo '<div class="select_wrapper spacing-units" original-title="' . esc_html__( 'Units', 'streamit' ) . '">';
				if ( isset( $this->field['units_label'] ) && ! Redux_Helpers::array_in_array( $this->field['units_label'], $unit_check ) ) {
					echo '<span class="width-label">',esc_html($this->field['units_label']),'</span>';
				};
				echo '<select data-placeholder="' . esc_html__( 'Units', 'streamit' ) . '" class="redux-spacing redux-spacing-units select ' . esc_attr( $this->field['class'] ) . '" original-title="' . esc_html__( 'Units', 'streamit' ) . '" id="' . esc_attr( $this->field['id'] ) . '_units"' . esc_attr( $select2_data ) . '>';
